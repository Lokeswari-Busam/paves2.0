...
export default function HeroSection() {
  return (
    <div className="relative w-full h-[340px] md:h-[320px] bg-white overflow-hidden">
      ...
      <div className="absolute right-30 bottom-25  h-[80%] w-auto z-30 hidden md:block">
        <Image
          src="/assets/payment-gateways.png"  // <-- Replace with your image
