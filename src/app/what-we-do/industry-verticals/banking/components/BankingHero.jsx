...
export default function BankingHero({ title, description, breadcrumb = [] }) {
  return (
      ...
      >
        <defs>
          <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
            <path d="M0 20 L40 20" stroke="white" strokeWidth="0.4" />
            <path d="M20 0 L20 40" stroke="white" strokeWidth="0.4" />
          </pattern>
        </defs>
